...
const techStackDatabase: TechStack[] = [
  ...
  },
  {
    ...
    cves: [
      { id: 'CVE-2021-44228', severity: 'critical', title: 'Log4j RCE', score: 10.0 },
      { id: 'CVE-2021-45046', severity: 'critical', title: 'Log4j Bypass', score: 9.8 },
      { id: 'CVE-2021-45105', severity: 'high', title: 'Log4j DoS', score: 7.5 },
    ],
    unscannedThreatsCount: 6,
    riskLevel: 'critical',
    riskScore: 9.8,
    ...
    remediations: [
      { id: 'rem-11', title: 'Critical: Update to 2.20.0', description: 'Immediate upgrade required due to critical RCE vulnerability', priority: 'critical', estimatedTime: '1-2 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    remediations: [
      { id: 'rem-12', title: 'Update to 2.20.0', description: 'Upgrade to patch remaining vulnerabilities', priority: 'critical', estimatedTime: '2-3 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 7, riskLevel: 'low' },
  ...
  },
  {
    ...
    cves: [
      { id: 'CVE-2022-22965', severity: 'critical', title: 'Spring4Shell RCE', score: 9.8 },
      { id: 'CVE-2022-22963', severity: 'high', title: 'Spring Cloud Function Expression Injection', score: 8.1 },
    ],
    unscannedThreatsCount: 5,
    riskLevel: 'critical',
    riskScore: 9.2,
    ...
    remediations: [
      { id: 'rem-13', title: 'Upgrade to Spring 6.1', description: 'Major version upgrade required to fix critical RCE', priority: 'critical', estimatedTime: '16-24 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 9, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    secureVersion: '6.1.0',
    cves: [
      { id: 'CVE-2023-34035', severity: 'high', title: 'Spring Security OAuth2 Token Validation', score: 7.5 },
    ],
    unscannedThreatsCount: 4,
    riskLevel: 'high',
    riskScore: 7.5,
    ...
    remediations: [
      { id: 'rem-14', title: 'Update to Spring 6.1.0', description: 'Update to fix OAuth2 token validation issue', priority: 'high', estimatedTime: '4-6 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 9, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    cves: [
      { id: 'CVE-2023-44487', severity: 'high', title: 'HTTP/2 Rapid Reset Attack', score: 7.5 },
      { id: 'CVE-2023-27536', severity: 'medium', title: 'Socket Closure DoS', score: 5.8 },
    ],
    unscannedThreatsCount: 4,
    riskLevel: 'high',
    riskScore: 6.8,
    ...
    remediations: [
      { id: 'rem-15', title: 'Upgrade to Nginx 1.26.0', description: 'Fix HTTP/2 vulnerabilities', priority: 'high', estimatedTime: '2-3 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 9, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    cves: [
      { id: 'CVE-2023-38545', severity: 'critical', title: 'mod_proxy Overflow', score: 9.6 },
      { id: 'CVE-2021-41773', severity: 'critical', title: 'Path Traversal RCE', score: 9.8 },
      { id: 'CVE-2023-44487', severity: 'high', title: 'HTTP/2 Rapid Reset', score: 7.5 },
    ],
    unscannedThreatsCount: 5,
    riskLevel: 'critical',
    riskScore: 8.9,
    ...
    remediations: [
      { id: 'rem-16', title: 'Critical: Update to 2.4.58', description: 'Fix critical RCE vulnerabilities', priority: 'critical', estimatedTime: '3-5 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 9, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    cves: [
      { id: 'CVE-2023-21919', severity: 'high', title: 'Connectors Authentication Bypass', score: 8.1 },
      { id: 'CVE-2023-21977', severity: 'high', title: 'Server Denial of Service', score: 7.5 },
    ],
    unscannedThreatsCount: 6,
    riskLevel: 'high',
    riskScore: 7.8,
    ...
    remediations: [
      { id: 'rem-17', title: 'Migrate to MySQL 8.0', description: 'EOL version needs immediate upgrade', priority: 'critical', estimatedTime: '8-12 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 8, riskLevel: 'low' },
  ...
  },
  {
    ...
    cves: [
      { id: 'CVE-2023-49088', severity: 'medium', title: 'Credential Exposure in Logs', score: 6.2 },
    ],
    unscannedThreatsCount: 3,
    riskLevel: 'medium',
    riskScore: 5.5,
    ...
    remediations: [
      { id: 'rem-18', title: 'Update boto3', description: 'Address credential exposure issues', priority: 'medium', estimatedTime: '2-3 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 9, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    cves: [
      { id: 'CVE-2023-5678', severity: 'high', title: 'Poly1305 MAC Timing Attack', score: 7.5 },
      { id: 'CVE-2023-2975', severity: 'medium', title: 'Denial of Service', score: 5.3 },
    ],
    unscannedThreatsCount: 5,
    riskLevel: 'high',
    riskScore: 7.2,
    ...
    remediations: [
      { id: 'rem-19', title: 'Upgrade OpenSSL to 3.x', description: 'EOL version with multiple vulnerabilities', priority: 'critical', estimatedTime: '4-6 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 9, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    secureVersion: '7.2.0',
    cves: [
      { id: 'CVE-2023-41053', severity: 'high', title: 'Key Expiration Race Condition', score: 8.1 },
    ],
    unscannedThreatsCount: 2,
    riskLevel: 'high',
    riskScore: 6.5,
    ...
    remediations: [
      { id: 'rem-20', title: 'Update to Redis 7.2', description: 'Fix race condition vulnerability', priority: 'high', estimatedTime: '2-4 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 9, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    secureVersion: '1.7.8',
    cves: [
      { id: 'CVE-2023-47108', severity: 'high', title: 'Privileged Container Escape', score: 8.8 },
    ],
    unscannedThreatsCount: 3,
    riskLevel: 'high',
    riskScore: 7.4,
    ...
    remediations: [
      { id: 'rem-21', title: 'Update containerd to 1.7.8', description: 'Fix container escape vulnerability', priority: 'critical', estimatedTime: '3-4 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 9, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    secureVersion: '8.5.0',
    cves: [
      { id: 'CVE-2023-38546', severity: 'critical', title: 'Buffer Overflow in HTTPS Proxy', score: 9.8 },
      { id: 'CVE-2023-38545', severity: 'critical', title: 'SOCKS5 Buffer Overflow', score: 9.6 },
    ],
    unscannedThreatsCount: 4,
    riskLevel: 'critical',
    riskScore: 9.5,
    ...
    remediations: [
      { id: 'rem-22', title: 'Critical: Update curl to 8.5.0', description: 'Critical buffer overflow vulnerabilities', priority: 'critical', estimatedTime: '1-2 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 10, riskLevel: 'no risk' },
      packageReliability: { score: 9, riskLevel: 'no risk' },
  ...
  },
  {
    ...
    cves: [
      { id: 'CVE-2023-45648', severity: 'high', title: 'Open Redirect', score: 7.2 },
      { id: 'CVE-2021-50129', severity: 'high', title: 'Partial Directory Disclosure', score: 7.5 },
    ],
    unscannedThreatsCount: 3,
    riskLevel: 'high',
    riskScore: 6.8,
    ...
    remediations: [
      { id: 'rem-23', title: 'Update Tomcat to 10.1.19', description: 'Fix open redirect and disclosure issues', priority: 'high', estimatedTime: '3-4 hours' },
    ],
    reliabilityIndicators: {
      contributorReputation: { score: 9, riskLevel: 'no risk' },
      packageReliability: { score: 8, riskLevel: 'low' },
...
const assetDatabase: Asset[] = [
  ...
  },
  {
    ...
    type: 'cloud-resource',
    riskLevel: 'high',
    techStacks: [techStackDatabase[14], techStackDatabase[3], techStackDatabase[17], techStackDatabase[18]],
    cveCount: 5,
  ...
  },
  {
    ...
    type: 'cloud-resource',
    riskLevel: 'critical',
    techStacks: [techStackDatabase[15], techStackDatabase[4], techStackDatabase[17]],
    cveCount: 6,
  ...
  },
  {
    ...
    type: 'cloud-resource',
    riskLevel: 'critical',
    techStacks: [techStackDatabase[8], techStackDatabase[20], techStackDatabase[17]],
    cveCount: 5,
